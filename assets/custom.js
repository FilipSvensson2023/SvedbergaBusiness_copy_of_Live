...
---------------------------------------------  */
/*global document, window, setTimeout, Swiper, createElementWithClass, createRatingsHtmlElement, Cookies, semanticTabs, Image, Shopify, Event, getComputedStyle, CustomEvent, enquire, IntersectionObserver, MutationObserver */
/*//jshint esversion: 6 */
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    nav_main,
		...
		Default = {
            ...
            window.assignIndex = function(em) {
							'use strict';
				...
				swipers: function () {
					...
					window.addEventListener("announcementSlider", function(event) {
						...
						if (top_bar && top_bar.children.length > 1 && !top_bar.classList.contains('m6kn')) {
